...
#[serde(rename_all = "snake_case")]
pub enum TranscriptionDockPosition {
    Left,
    Right,
    Bottom,
}
...
pub struct TranscriptionSettings {
    ...
    pub dock: TranscriptionDockPosition,
...
impl Settings for TranscriptionSettings {
    const KEY: Option<&'static str> = Some("assistant");

    type FileContent = TranscriptionSettingsContent;
...
pub struct TranscriptionSettingsContent {
    /// Whether to show the assistant panel button in the status bar.
    ///
    /// Default: true
    ...
    ///
    /// Default: right
    pub dock: Option<TranscriptionDockPosition>,
    /// Default width in pixels when the assistant is docked to the left or right.
    ///
    /// Default: 640
