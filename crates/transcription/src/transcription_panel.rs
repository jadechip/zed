...
pub fn init(cx: &mut AppContext) {
    TranscriptionSettings::register(cx);
    cx.observe_new_views(
        |workspace: &mut Workspace, _cx: &mut ViewContext<Workspace>| {
            workspace
                .register_action(|workspace, _: &ToggleFocus, cx| {
                    workspace.toggle_panel_focus::<TranscriptionPanel>(cx);
                })
                .register_action(TranscriptionPanel::inline_assist)
                .register_action(TranscriptionPanel::cancel_last_inline_assist)
...
impl TranscriptionPanel {
    ...
    pub fn load(
        ...
        cx.spawn(|mut cx| async move {
            ...
            let (provider_kind, api_url, model_name) = cx.update(|cx| {
                let settings = TranscriptionSettings::get_global(cx);
                anyhow::Ok((
    ...
    pub fn inline_assist(
        ...
        let Some(assistant) = workspace.panel::<TranscriptionPanel>(cx) else {
            return;
        };
        ...
        if assistant.update(cx, |assistant, _| assistant.has_credentials()) {
            ...
            cx.spawn(|workspace, mut cx| async move {
                ...
                if assistant.update(&mut cx, |assistant, _| assistant.has_credentials())? {
                    ...
                    workspace.update(&mut cx, |workspace, cx| {
                        workspace.focus_panel::<TranscriptionPanel>(cx)
                    })?;
                }
    ...
    fn cancel_last_inline_assist(
        ...
        if let Some(panel) = workspace.panel::<TranscriptionPanel>(cx) {
    ...
    fn confirm_inline_assist(
        ...
        let Some(mut model_name) = TranscriptionSettings::get_global(cx)
            .provider_model_name()
            .log_err()
        else {
            return;
...
impl Panel for TranscriptionPanel {
    fn persistent_name() -> &'static str {
        "TranscriptionPanel"
    }

    fn position(&self, cx: &WindowContext) -> DockPosition {
        match TranscriptionSettings::get_global(cx).dock {
            TranscriptionDockPosition::Left => DockPosition::Left,
            TranscriptionDockPosition::Bottom => DockPosition::Bottom,
            TranscriptionDockPosition::Right => DockPosition::Right,
        }
    }
    ...
    fn set_position(&mut self, position: DockPosition, cx: &mut ViewContext<Self>) {
        settings::update_settings_file::<TranscriptionSettings>(
            self.fs.clone(),
            cx,
            move |settings| {
                let dock = match position {
                    DockPosition::Left => TranscriptionDockPosition::Left,
                    DockPosition::Bottom => TranscriptionDockPosition::Bottom,
                    DockPosition::Right => TranscriptionDockPosition::Right,
                };
    ...
    fn icon(&self, cx: &WindowContext) -> Option<IconName> {
        Some(IconName::Transcription).filter(|_| TranscriptionSettings::get_global(cx).button)
    }

    fn icon_tooltip(&self, _cx: &WindowContext) -> Option<&'static str> {
        Some("Transcription Panel")
    }
...
impl EventEmitter<PanelEvent> for TranscriptionPanel {}

impl FocusableView for TranscriptionPanel {
...
impl ConversationEditor {
    ...
    fn quote_selection(
        ...
        let Some(panel) = workspace.panel::<TranscriptionPanel>(cx) else {
            return;
        };
        ...
        h_flex()
            ...
            .child(
                h_flex()
                    ...
                    .child(
                        IconButton::new("include_conversation", IconName::Transcription)
...
fn report_assistant_event(
    ...
    let Ok(model_name) = TranscriptionSettings::get_global(cx).provider_model_name() else {
        return;
    };
